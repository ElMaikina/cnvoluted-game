...
class PlayerSprite(pygame.sprite.Sprite):
    ...
    def __init__(self, player, x, y):
        ...
        if type(player) is Kyle:
            ...
            self.sprites.append(pygame.image.load("sprites\kyle\zoom\\0.png"))
            self.sprites.append(pygame.image.load("sprites\kyle\zoom\\1.png"))
            self.sprites.append(pygame.image.load("sprites\kyle\slide\\0.png"))
            self.sprites.append(pygame.image.load("sprites\kyle\kneel\\0.png"))
